...
<div class="flex-col gap-6" style="max-width: 800px; margin: 0 auto;">
    ...
    <form method="post" class="card flex-col gap-6">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
            <div class="flex-col gap-2">
                <label class="label">Categoria <span style="font-size: 0.7em; color: #999;">({{ categories.count }} disponíveis)</span></label>
                <select name="category" class="input" required style="background-color: white !important; color: #333 !important;">
